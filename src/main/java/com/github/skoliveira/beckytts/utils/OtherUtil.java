...
public class OtherUtil
{
    ...
    public static Path getPath(String path)
    {
        ...
        if(path.toLowerCase().startsWith(WINDOWS_INVALID_PATH))
        {
            ...
            try
            {
                path = new File(BeckyTTS.class.getProtectionDomain().getCodeSource().getLocation().toURI()).getParentFile().getPath() + File.separator + filename;
            }
     ...
     * 
     * @param activity the activity, including the action such as 'playing' or 'watching'
