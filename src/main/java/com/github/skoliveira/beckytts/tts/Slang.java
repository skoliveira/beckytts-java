...
public class Slang extends HashMap<String,String> {

    /**
     * 
     */
    private static final long serialVersionUID = 7314696315261447810L;
    ...
    public Slang() {
        ...
        this.put("sdds", "saudades");
        this.put("fmz", "firmeza");
        this.put("ctz", "certeza");
        this.put("blz", "beleza");
        this.put("tmj", "tamo junto");
        this.put("dnv", "de novo");
        this.put("vc", "você");
        this.put("vcs", "vocês");
        this.put("tdb", "tudo bem");
        this.put("td", "tudo");
        this.put("tb", "também");
        this.put("nd", "nada");
        this.put("ndv", "nada a ver");
        this.put("ag", "agora");        
        this.put("hj", "hoje");
        this.put("og", "hoje");
        this.put("t+", "até mais");
        ...
        this.put("krl", "caralho");
        this.put("krlh", "caralho");
        ...
        this.put("tnc", "toma no cu");
        this.put("vtnsc", "vai tomar no seu cu");
